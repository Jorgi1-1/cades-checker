      ...
      >
        <div className="bg-stone-900/60 backdrop-blur-xl border border-stone-800 rounded-3xl p-8 shadow-2xl relative z-10 text-white">
          ...
          <div className="space-y-4">
            <div className="flex bg-stone-800/50 p-1 rounded-xl mb-6">
              <button
                onClick={() => { setIsLogin(true); setError(""); }}
                className={`flex-1 py-2 text-sm font-medium rounded-lg transition-all ${isLogin ? 'bg-emerald-500 text-stone-950 shadow-md' : 'text-stone-400 hover:text-stone-200'}`}
              >
                Inicia Sesión
              </button>
              <button
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-stone-900/60 text-stone-400">O</span>
              </div>
            </div>
