        ...
        <div className="min-h-screen bg-stone-950 text-stone-100 p-6 relative overflow-hidden pb-32">
            ...
            <div className="flex justify-between items-center mb-8 relative z-10 p-2">
                <div>
                    ...
                    <p className="text-stone-400 text-sm mt-1">Pase de lista Cadés</p>
                </div>
            ...
            <div className="max-w-md mx-auto space-y-6 relative z-10">
                ...
                >
                    {latestEventId ? (
                        <>
                            ...
                            <div className="mt-4 text-center">
                                <p className="text-emerald-400 font-medium text-sm flex items-center justify-center gap-2">
                                    ...
                                    Pase válido para sesión actual
                                </p>
                            </div>
                        </>
                    ) : (
                        <div className="flex flex-col items-center justify-center py-8 text-center">
                            ...
                            <p className="text-stone-300 font-medium">Esperando sesión...</p>
                            <p className="text-stone-500 text-sm mt-2 max-w-[200px]">Tu código QR aparecerá aquí en cuanto el coordinador inicie la sesión de hoy.</p>
                        </div>
                    )}
                </motion.div>
                ...
                >
                    ...
                    <div className="pt-2 border-t border-stone-800/50 flex flex-col gap-2 text-sm">
                        <span className="text-stone-400">Has llegado a tiempo a {attendedEvents} de {totalEvents} sesiones.</span>
                        {isDanger ? (
